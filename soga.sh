...
docker run $COMMON_OPTS --name v72 $IMAGE --type=sspanel-uim --server_type=v2ray --api=webapi --webapi_url=$WEBAPI_URL --webapi_key=$WEBAPI_KEY --node_id=72 --dns_cache_time=10 --soga_key=$SOGA_KEY --forbidden_bit_torrent=true --proxy_protocol=true --force_vmess_aead=true --tunnel_enable=true --tunnel_type=tcp-tunnel --tunnel_password=80a8d91d-9347-40ae-b3a6-abffdf3d61f0
...
docker run $COMMON_OPTS --name v375 $IMAGE --type=sspanel-uim --server_type=v2ray --api=webapi --webapi_url=$WEBAPI_URL --webapi_key=$WEBAPI_KEY --node_id=375 --dns_cache_time=10 --soga_key=$SOGA_KEY
